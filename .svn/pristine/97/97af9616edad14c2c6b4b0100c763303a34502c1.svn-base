...
const ViewComponent = (props) => {
  ...
  const listProps = {
    columns: [ // 和antd table组件的列定义相同
      { title: '年度', width: 230, dataIndex: 'demandPlan.year', key: 'demandPlan.year', link: 'open', sorter: true },
      { title: '月份', width: 230, dataIndex: 'demandPlan.month', key: 'demandPlan.month', link: 'open', sorter: true },
      { title: '填报时间', width: 230, dataIndex: 'createdTime', key: 'createdTime', fulltext: false, sorter: true },
      { title: '填报人', width: 185, dataIndex: 'createdBy.name', key: 'createdBy.name', sorter: true },
      { title: '备注', width: 230, dataIndex: 'demandPlan.remark', key: 'demandPlan.remark', sorter: true },
    ],
    colDefaultLink: 'open',
  };
