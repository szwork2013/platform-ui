...
class MyDeptView extends React.Component{
  ...
  render(){
    ...
    //获取当前用户部门id
      ...
      let searchParam={ //搜索条件
        ...
        filter: { //过滤规则
          ...
          where: 'o.reportType=2 and o.periodType=0 and o.orgLevel=2', //条件
        },
        size: 20, //指定每页记录数
      ...
      new: true, //显示新增按钮
      newPayloadRender: () => {return {processNo:'',reportType:2,periodType:0,orgLevel:2}},
      delete: true, //显示删除按钮
      newRow:false
      }
    ...
    return (
        <View {...props}
          uid='yearresolvecharge_all'
          key='yearresolvecharge_all'
