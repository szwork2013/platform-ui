...
const ViewComponent = ( props ) => {
  ...
  let searchParam={ //搜索条件
    filter: { //过滤规则
      ...
      where: 'o.type=4 and o.orgLevel=0', //条件
    },
    size: 20, //指定每页记录数
  ...
  const listProps = {
    columns:[ // 和antd table组件的列定义相同
      ...
      { title: '季度', width: 190, dataIndex: 'quarter', key: 'quarter',link:'open', sorter:true},
      { title: '批次号',width: 190, dataIndex: 'batchNo', key: 'batchNo', sorter:true},
      { title: '填报时间', width: 195, dataIndex: 'createdTime', key: 'createdTime', fulltext:false, sorter:true},
