...
const deptTree=orgTreeProps();
  ...
  const listProps = {
    columns: [
      ...
      { type:'select',title: '部门/科室 ', width: 200, dataIndex: 'sourceOrg', key: 'sourceOrg', sorter: true,
      ...
      {type:'select', title: '代表', width: 200, dataIndex: 'targetOrg', key: 'targetOrg', sorter: true, 
      editor: <DropdownSelect {...deptTree} />,textRender:(value,record)=>{
