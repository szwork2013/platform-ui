    ...
    //获取当前用户部门id
      ...
      let searchParam={ //搜索条件
        ...
        filter: { //过滤规则
          ...
          where: 'o.reportType=0 and o.periodType=2 and o.orgLevel=1 and o.createdBy.id='+deptId, //条件
        },
        size: 20, //指定每页记录数
      ...
      new: true, //显示新增按钮
      newPayloadRender: () => {return {processNo:'',reportType:0,periodType:2,orgLevel:1}},
      delete: true, //显示删除按钮
      newRow:false
      }
